...
public class OWBExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://schemas.datacontract.org/2004/07/MulticomNet.MultiPagos.Domain^^PointOfSaleConfig",OWBPointOfSaleConfig.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MulticomNet.MultiPagos.Domain^^CartaoRecarga",OWBCartaoRecarga.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MulticomNet.MultiPagos.Domain^^Pagamento",OWBPagamento.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MulticomNet.MultiPagos.Domain.Recarga^^Operadora",OWBOperadora.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MulticomNet.MultiPagos.Domain.Recarga^^Produto",OWBProduto.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MultiPagos.PDVController.Contracts^^PointOfSaleConfig",OWBPointOfSaleConfig_1.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MultiPagos.PDVController.Contracts^^CartaoRecarga",OWBCartaoRecarga_1.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MultiPagos.PDVController.Contracts^^Operadora",OWBOperadora_1.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MultiPagos.PDVController.Contracts^^Produto",OWBProduto_1.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MultiPagos.PDVController.Contracts^^ArrayOfOperadora",OWBArrayOfOperadora.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MultiPagos.PDVController.Contracts^^ArrayOfProduto",OWBArrayOfProduto.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public OWBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OWBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OWBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class)) {
                java.lang.String xmlName=OWBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,OWBExtendedSoapSerializationEnvelope.class);
