 ...
 */
public class ContaSemFaturaDetalheAdapter extends RecyclerView.Adapter<ContaSemFaturaDetalheAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_contasemfatura_detalhe,parent,false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.statusContaSemFatura.setText(contaSemFatura.getStatus());
        holder.codigoBarras.setText(contaSemFatura.getCodigodeBarras());
    ...
    public ContaSemFaturaDetalheAdapter(List<ContaSemFatura> contaSemFaturas){
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        public TextView dataVencimento, valorPagamento, codigoConta,codigoBarras,statusContaSemFatura;
        ...
        public MyViewHolder(View view){
            ...
            codigoBarras= (TextView)view.findViewById(R.id.txt_CodigoBarrasDetalhe);
            statusContaSemFatura= (TextView)view.findViewById(R.id.txt_StatusContaSemFatura);
